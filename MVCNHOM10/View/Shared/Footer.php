...
<div id="footer-home" style="margin-top: 0px;" class="hidden-scroll hidden-scrollefScroll4">
    ...
    <div class="footer-bottom">
        ...
        <div class="ctx">Địa chỉ: Tam Tiến- Yên Thế - Bắc Giang
            Email: toducanh012@gmail.com</div>
        <div class="ctx">©2021 - Bản quyền thuộc về Tập đoàn TNHH SShop</div>
    </div>
</div>
</div>
